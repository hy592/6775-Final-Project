...
*/
  ...
  data_type_x random_array[matrix_size]={3.58964059e-05,1.63794645e-04,1.48891121e-05,4.44594756e-04
  ...
  //ifstream input_file("DI_MIMO_J_Conv_Fixed_Mult0.txt");
   ...
   for (int k=startNum; k < startNum+numProblems; k++){
	   ...
	   ifstream input_file1(file_directory + file_name);
